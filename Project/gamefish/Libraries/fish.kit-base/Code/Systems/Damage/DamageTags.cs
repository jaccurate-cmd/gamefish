...
public static partial class DamageTags
{
	...
	/// <summary>
	/// From being near that bright green stuff.
	/// </summary>
	...
	/// </summary>
	public const string TELEPORT = "tele";
	public const string TELEFRAG = TELEPORT;
	...
	/// <summary>
	/// Used when falling out of the map/safe area.
	/// </summary>
	public const string VOID = "void";
	public const string ABYSS = VOID;
}
